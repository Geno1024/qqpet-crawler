mkdir bin-release; cd bin-release
    ...
    mkdir Data; cd Data
        ...
        mkdir res; cd res
                ...
                mkdir 22; cd 22
                    ...
                    do
                        ...
                        then
                            ...
                            cd .. # bin-release/Data/res/scene/22/bg_V$i
                        fi
                    done

                cd .. # bin-release/Data/res/scene/22

            cd .. # bin-release/Data/res/scene
            ...
            cd .. # bin-release/Data/res/topicon
         ...
         #                       break
          #                  fi
           #             done
                    ...
                    cd .. # bin-release/Data/res/Avatar/00$i
                    
                done
            
            cd .. # bin-release/Data/res/Avatar

        cd .. # bin-release/Data/res
